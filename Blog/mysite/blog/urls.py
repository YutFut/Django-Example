...
urlpatterns = [
    ...
    path('tag/<slug:tag_slug>/post_list_tag/', views.post_list_tag, name='post_list_tag'),
    ...
    path('<int:year>/<int:month>/<int:day>/<str:author>/<slug:post>/post_detail_similar_posts/',
         views.post_detail_similar_posts, name='post_detail_similar_posts'),
